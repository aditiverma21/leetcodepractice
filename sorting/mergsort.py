...
def merge_sort(unsorted_list):
    ...
    #here we are storing the return of merge_sort and then sending the left and right to merge function
    #in base case of 2 and 8 in 
    # left_side=merge_sort(left_side)
    # right_side=merge_sort(right_side)
    
    # t = merge(left_side,right_side)
    return merge(merge_sort(unsorted_list[:mid]), merge_sort(unsorted_list[mid:]))
